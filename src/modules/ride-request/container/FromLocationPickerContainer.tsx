...
const FromLocationPickerContainer: React.FC = () => {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            <h1 className="text-2xl font-bold mb-6 text-center">Pick Your Starting Location</h1>
            <InputField
                label="From"
...
export default FromLocationPickerContainer;
